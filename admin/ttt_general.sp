...
#define QUERY_INSERT_CHAT "INSERT INTO `bb_chat` (`time`, `account_id`, `message`) VALUES (UTC_TIMESTAMP(), '%d', '%s');"
#define QUERY_INSERT_MSG  "INSERT INTO `bb_msg` (`time`, `account_id`, `receiver_id`, `message`) VALUES (UTC_TIMESTAMP(), '%d', '%d', '%s');"
